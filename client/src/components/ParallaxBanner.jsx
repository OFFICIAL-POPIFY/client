...
function ParallaxBanner() {
  return (
    <div className={styles["ParallaxBanner"]}>
      ...
      <ParallaxComponent url="https://img1.daumcdn.net/thumb/R800x0/?scode=mtistory2&fname=https%3A%2F%2Ft1.daumcdn.net%2Ftistoryfile%2Ffs15%2F30_tistory_2009_02_24_21_15_49a3e4de817c9%3Foriginal" title="영원하지 않은 공간으로부터의 무한한 순간들" />
    </div>
  );
}
